package igtools.common.charts.palette;

import igtools.common.nucleotide.B3Nucleotide;

import java.awt.Color;

public class BlueB3NucleotidePalette implements B3NucleotidePalette{
	//255, 128, 64, 32

	public static final Color A_COLOR = new Color(0, 0, 255);
	public static final Color C_COLOR = new Color(0, 0, 32);
	public static final Color G_COLOR = new Color(0, 0, 64);
	public static final Color T_COLOR = new Color(0, 0, 128);
