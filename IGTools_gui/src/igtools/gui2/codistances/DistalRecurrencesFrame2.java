 ...
 * @author vbonnici
 */
public class DistalRecurrencesFrame2 extends javax.swing.JFrame {
    ...
    public DistalRecurrencesFrame2(WSSequence wsseq) {
       this.wsseq = wsseq;
    ...
    public DistalRecurrencesFrame2(WSSequence wsseq, IELSAIterator it_1, IELSAIterator it_2) {
        this(wsseq);
        this.it_1 = it_1;
        this.it_2 = it_2;
        makeChart();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DistalRecurrencesFrame2 frame = new DistalRecurrencesFrame2(wsseq, it_1.clone(), it_2.clone());
...
//            }
        ...
        */
        ...
        TreeMap<Integer,Integer> codists = igtools.analyses.recurrences.carpena.DistalRecurrence.proper_global_codistances(it_1,maxDist);
        
        
        final XYSeries series = new XYSeries("");
        
        for(Map.Entry<Integer,Integer> entry : codists.entrySet()){
            series.add(entry.getKey(), entry.getValue());
        }
