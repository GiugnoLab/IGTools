...
import igtools.analyses.distribution.peaks.ExpDistributionPeakFinder;
...
public class ProperEDistalDistributionsFrame extends javax.swing.JFrame {
    ...
    public ProperEDistalDistributionsFrame(WSSequence wsseq) {
        ...
        initComponents();
        this.setTitle("Self-RDD: "+wsseq.getName());
    ...
    private void initComponents() {
        ...
        showEstGeomCheckBox.setVisible(false);
        showEstGeomCheckBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                showEstGeomCheckBoxActionPerformed(evt);
            }
        });

        showEstExpCheckBox.setText("show est. Exponential");
        showEstExpCheckBox.setVisible(false);

        showEstFExpCheckBox.setText("show est. FExponential");
        showEstFExpCheckBox.setVisible(false);
        showEstFExpCheckBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                showEstFExpCheckBoxActionPerformed(evt);
            }
        });
        ...
        showRandomizedCheckBox.setVisible(false);
        ...
        resampledCheckBox.setVisible(false);

        peaksCheckBox.setText("Peaks");
        peaksCheckBox.setVisible(false);
        ...
        period3CheckBox.setText("3Period");
        period3CheckBox.setVisible(false);
                ...
                try{
                    ...
                    if(distr.length > 0){
                        ...
                        for(int i=1; i<distr.length; i++){
                            ...
                            if(distr[i][0] == this.pickedDistance){
                            	System.out.println("@ "+distr[i][0]+" "+distr[i][1]);
                            }
                        }
                        ...
                        if(this.pickedDistance > 0){
                        	printer = new FileWriter(chooser.getSelectedFile().getAbsoluteFile()+".pick", false);
                        	...
                        	System.out.println();
                        	System.out.println(pickedDistance);
                        	System.out.println(newNof);
                        	
                            int k = wordIt.k();
                            B3Nucleotide[] kmer;
                            for(int i=0; i<p_pos.length; i++){
                            	kmer = new B3Nucleotide[pickedDistance+k];
                            	this.wsseq.getB3seq().getB3(p_pos[i], kmer);
                            	//System.out.println(B3Nucleotide.toString(kmer));
                            	printer.write(B3Nucleotide.toString(kmer)+"\n");
                            }
...
//            }
    ...
    private void showEstFExpCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showEstFExpCheckBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_showEstFExpCheckBoxActionPerformed

    private void showEstGeomCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showEstGeomCheckBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_showEstGeomCheckBoxActionPerformed
